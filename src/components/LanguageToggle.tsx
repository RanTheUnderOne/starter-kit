    ...
    <button
      ...
      className={
        tone === "dark"
          ...
          : "inline-flex h-9 items-center gap-2 rounded-full border border-border bg-white/80 px-3 text-xs font-semibold text-foreground transition hover:bg-secondary"
      }
    >
