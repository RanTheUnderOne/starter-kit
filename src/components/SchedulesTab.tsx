  ...
  return (
    <div className="mx-auto w-full max-w-6xl space-y-7 px-4 pb-28 pt-7 sm:px-7 lg:px-10 lg:pb-12 lg:pt-10">
      <header className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <p className="text-[11px] font-bold tracking-[0.2em] text-muted-foreground">{t("schedules.eyebrow")}</p>
          <h1 className="mt-2 text-3xl font-semibold tracking-[-0.035em] text-foreground sm:text-4xl">{t("schedules.title")}</h1>
      ...
      {loading ? (
        ...
        <div className="grid gap-5 xl:grid-cols-2">
          {jobs.map((job) => {
            ...
            return (
              <article key={job.id} className="alfi-panel overflow-hidden rounded-xl">
