  ...
  return (
    <div className="mx-auto w-full max-w-5xl space-y-7 px-4 pb-28 pt-7 sm:px-7 lg:px-10 lg:pb-12 lg:pt-10">
      <header>
        ...
        <h1 className="mt-2 text-3xl font-semibold tracking-[-0.035em] text-teal-950 sm:text-4xl">{t("whatsapp.title")}</h1>
        <p className="mt-2 max-w-2xl text-sm leading-6 text-teal-950/60">{t("whatsapp.subtitle")}</p>
      </header>
